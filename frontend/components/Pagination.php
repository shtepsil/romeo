...
class Pagination
{
    ...
    protected $previousText = '<i class="zmdi zmdi-long-arrow-left"></i>';
    protected $nextText = '<i class="zmdi zmdi-long-arrow-right"></i>';
    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li><a href="' . htmlspecialchars($this->getPrevUrl()) . '" class="next page-numbers">'. $this->previousText .'</a></li>';
        }

        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                if($page['isCurrent']){
                    $html .= '<li><span class="current">' . htmlspecialchars($page['num']) . '</span></li>';
                }else{
                    $html .= '<li' . ($page['isCurrent'] ? ' class="current"' : '') . '><a href="' . htmlspecialchars($page['url']) . '">' . htmlspecialchars($page['num']) . '</a></li>';
                }
            } else {
