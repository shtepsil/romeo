...
function barcode_encode_bars($ean, $encoding = "EAN-13"){
...
function barcode_print($code, $scale = 2 ,$mode, $total_y){
    $bars=barcode_encode_bars($code);
    barcode_outimage($bars['text'],$bars['bars'],$scale, $mode, $total_y);
    return $bars;
}

barcode_print('0031002000026', $scale = 2 ,$mode = "png", $total_y);